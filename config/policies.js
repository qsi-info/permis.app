...
module.exports.policies = {
  ...
  '*': ['safari304', 'setUserLocale', 'isAuthenticated', 'isConfigure', 'isIE'],


  SetupController: {
  	'*' : ['isAlreadySetup', 'isAdmin'],
  },
  ...
  'equipementfiche': ['isAuthenticated', 'applyPermissions', 'createdBy', 'updatedBy'],
  EquipementFicheController: {
    find: true,
  }
